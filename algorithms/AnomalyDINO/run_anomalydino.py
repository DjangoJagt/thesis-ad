...
def parse_args():
    ...
    parser.add_argument("--eval_clf", default=False, action=argparse.BooleanOptionalAction, help="Evaluate anomaly detection performance.")
    ...
    parser.add_argument("--objects", nargs='+', type=str, default=None,
                        help="List of specific objects/products to run. If not provided, all objects in the dataset will be used.")
...
if __name__=="__main__":
    ...
    if args.objects is not None:
        ...
        if len(objects) == 0:
            raise ValueError(f"None of the requested objects {args.objects} found in dataset {args.dataset}")
        print(f"Running on specific objects: {objects}")
