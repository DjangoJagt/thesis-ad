...
def generate_html(crop_mode=False):
    ...
    <head>
        ...
        <script>
            ...
            function setQuery(q) {{
                ...
                // If query exactly matches a product name, switch dropdown to it
            ...
            function applyFilters() {{
                ...
                cards.forEach(card => {{
                    ...
                    card.style.display = (cardStatusOk && cardProductOk && cardQueryOk) ? 'block' : 'none';
                }});
            }}
        </script>
    </head>
    ...
    for idx, row in df.iterrows():
        ...
        product_display = html.escape(product_raw)
        ...
        html_content += f"""
        <div class="card {status}" data-product="{html.escape(product_raw)}" data-sku="{html.escape(sku_raw)}">
            <div class="header">
                <span class="product-name">{product_display}</span>
