...
def generate_html(crop_mode=False):
    ...
    <head>
        ...
        <style>
            ...
            .analysis-text {{ color: #333; font-size: 0.9em; line-height: 1.2; max-width: 600px; }}
            .confidence-badge {{ background: #17a2b8; color: white; padding: 4px 8px; border-radius: 4px; font-size: 0.85em; white-space: nowrap; }}
        ...
        <div class="card {status}">
            ...
            <div class="footer">
                <div class="status-group">
                    ...
                    {f'<span class="confidence-badge">Confidence: {confidence}</span>' if str(confidence) not in ['','nan','None'] else ''}
                </div>
