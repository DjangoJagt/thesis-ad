...
INTERNAL DECISION ORDER (DO NOT OUTPUT INTERMEDIATE STEPS):
1. First, inspect only the tote floor, corners, and gaps for wetness or leakage.
2. If any leakage or exposed product is found → ANOMALOUS.
3. Only if step 1 is clear, evaluate packaging integrity and SKU correctness.
